    ...
    return (
        <div className="space-y-8">
            <div className="text-center mb-12">
                <h2 className="gradient-text-primary flex items-center justify-center mb-6">
                    <span className="mr-4 text-5xl">🤖</span>
                    AI Pitch Deck Generator
                </h2>
                <p className="glassmorphism-text text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="glassmorphism rounded-3xl p-8 space-y-8 shadow-xl border border-white border-opacity-20">
                    <div className="text-center">
                        <h3 className="glassmorphism-heading text-2xl flex items-center justify-center mb-4">
                            <span className="mr-3 text-3xl">🏢</span>
                            Company Information
                        </h3>
                        <p className="glassmorphism-text">Tell us about your company to generate tailored content</p>
                    </div>

                    <div className="space-y-6">
                        <div>
                            <label className="glassmorphism-label flex items-center">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="glassmorphism-input textarea"
